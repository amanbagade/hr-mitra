class EmployeesController < ApplicationController
  ...
  def create
    ...
    if @employee.save
      redirect_to employee_path(@employee), notice: 'Employee has been created sucessfully'
    else
      render :new
    end
  end
  ...
  def update
    if @employee.update(employee_params)
      redirect_to employee_path, notice: "Employee has been updated sucessfully"
    else
      render :edit
    end
  end
  ...
  def destroy
    if @employee.destroy
      ...
      redirect_to employee_path(@employee), alert: 'Failed to delete employee'
    end
  end
  private
  def employee_params
